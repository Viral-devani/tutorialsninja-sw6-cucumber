...
public class LaptopAndNotebookPageSteps {
    ...
    public void iFilledAllMandatoryFieldOfCheckoutPage() {
        new CheckoutPage().enterFirstName("Viral");
        new CheckoutPage().enterLastName("Devani");
        new CheckoutPage().enterEmailId("viral");
        new CheckoutPage().enterTelephone("0723963861");
        new CheckoutPage().enterAddressLine1("10,Downing street");
        new CheckoutPage().enterCity("London");
        new CheckoutPage().enterPostCode("Sw12Nw");
